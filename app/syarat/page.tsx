...
export const metadata: Metadata = {
  title: "Syarat & Ketentuan | Twenti Studio",
  description:
    "Syarat dan ketentuan penggunaan layanan serta situs Twenti Studio.",
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside space-y-3 text-white/80 mb-6 ml-4">
              ...
              <li>
                ...
                either "the Company", "We", "Us" or "Our" in these Terms and
                Conditions) refers to PT TWENTI STUDIO NUSANTARA, Balikpapan,
                Kalimantan Timur.
              </li>
              <li>
              ...
              <li>
                ...
                (also referred to as "Terms") means these Terms and Conditions,
                including any documents expressly incorporated by reference,
                which govern Your access to and use of the Service and form the
