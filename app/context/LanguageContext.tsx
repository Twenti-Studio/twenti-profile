...
export const translations: Translations = {
  ...
  "nav.pricing": { id: "Paket & Harga", en: "Packages & Pricing" },
  "nav.about": { id: "Tentang Twenti", en: "About Twenti" },
  "nav.insight": { id: "Insight", en: "Insight" },
  ...
  "home.hero.cta2": {
    id: "Bangun Produk Bersama Twenti",
    en: "Build With Twenti",
  },
  ...
  "home.about.tagline": {
    id: "Membangun Produk Unggulan",
    en: "Building Product Excellence",
  },
  ...
  "home.trustedBy.title": {
    id: "Sistem yang Kami Bangun,",
    en: "The Systems We Built,",
  },
  "home.trustedBy.titleHighlight": {
    id: "Sudah Berjalan",
    en: "Already Running",
  },
  ...
  "home.trustedBy.viewPortfolio": {
    id: "Lihat Portofolio Lengkap",
    en: "View Full Portfolio",
  },

  // HOME PAGE - PRODUCTS

  "home.products.label": { id: "Produk Kami", en: "Our Products" },
  "home.products.title": { id: "Produk yang Kami", en: "Products We Build" },
  "home.products.titleHighlight": {
    id: "Bangun dan Kembangkan",
    en: "and Grow Ourselves",
  },
  "home.products.subtitle": {
    id: "Bukan portofolio jasa, ini produk milik Twenti Studio yang kami rancang, bangun, dan jalankan sendiri.",
    en: "Not a service portfolio, these are Twenti Studio's own products, which we design, build, and run ourselves.",
  },
  "home.products.visit": { id: "Kunjungi", en: "Visit" },
  "home.products.viewAll": {
    id: "Lihat Semua Produk",
    en: "View All Products",
  },

  // HOME PAGE - WHAT WE BUILD

  "home.whatWeBuild.label": { id: "Yang Kami Bangun", en: "What We Build" },
  "home.whatWeBuild.title": {
    id: "Kemampuan yang Kami Pakai",
    en: "The Capabilities Behind",
  },
  "home.whatWeBuild.titleHighlight": {
    id: "untuk Produk Kami Sendiri",
    en: "Our Own Products",
  },
  "home.whatWeBuild.subtitle": {
    id: "Empat kemampuan inti yang kami asah lewat produk sendiri, dan kami pakai juga saat membangun bersama pihak lain.",
    en: "Four core capabilities we sharpen on our own products, and bring to the table when we build with others.",
  },
  "home.whatWeBuild.design.title": {
    id: "Product Design",
    en: "Product Design",
  },
  "home.whatWeBuild.design.desc": {
    id: "Product discovery, user flow, wireframe, UI/UX, dan prototyping.",
    en: "Product discovery, user flow, wireframing, UI/UX, and prototyping.",
  },
  "home.whatWeBuild.development.title": {
    id: "Product Development",
    en: "Product Development",
  },
  "home.whatWeBuild.development.desc": {
    id: "Website, web application, mobile application, backend, dan database.",
    en: "Websites, web applications, mobile applications, backend, and databases.",
  },
  "home.whatWeBuild.quality.title": {
    id: "Product Quality",
    en: "Product Quality",
  },
  "home.whatWeBuild.quality.desc": {
    id: "QA, testing, performance review, dan product improvement.",
    en: "QA, testing, performance review, and product improvement.",
  },
  "home.whatWeBuild.infrastructure.title": {
    id: "Product Infrastructure",
    en: "Product Infrastructure",
  },
  "home.whatWeBuild.infrastructure.desc": {
    id: "Deployment, arsitektur software, maintenance, dan konsultasi teknis.",
    en: "Deployment, software architecture, maintenance, and technical consultation.",
  },

  // LABEL PRODUK / PROYEK

  "label.twentiProduct": { id: "Produk Twenti", en: "Twenti Product" },
  "label.clientProject": { id: "Proyek Klien", en: "Client Project" },
  "label.internalExperiment": {
    id: "Eksperimen Internal",
    en: "Internal Experiment",
  },
  "label.inDevelopment": { id: "Sedang Dikembangkan", en: "In Development" },

  // CLIENT WORKS (halaman produk)

  "clientWorks.label": { id: "Client Works", en: "Client Works" },
  "clientWorks.title": { id: "Yang Kami Bangun", en: "What We Built" },
  "clientWorks.titleHighlight": { id: "Bersama Klien", en: "With Clients" },
  "clientWorks.subtitle": {
    id: "Produk dan sistem yang kami rancang serta bangun untuk bisnis dan organisasi. Klik salah satu untuk melihat detailnya.",
    en: "Products and systems we designed and built for businesses and organizations. Click any of them for details.",
  },

  // WORK WITH US - INTRO

  "work.heroTitle": { id: "Bangun Produk", en: "Build Your Product" },
  "work.heroHighlight": { id: "Bersama Twenti", en: "With Twenti" },
  "work.heroSubtitle": {
    id: "Selain mengembangkan produk internal, Twenti Studio juga membuka kolaborasi dengan bisnis, organisasi, dan founder untuk merancang serta membangun produk digital.",
    en: "Beyond developing our own products, Twenti Studio opens collaboration with businesses, organizations, and founders to design and build digital products.",
  },

  // WORK WITH US - BENTUK KOLABORASI

  "work.forms.label": { id: "Bentuk Kolaborasi", en: "Ways to Collaborate" },
  "work.forms.title": { id: "Tiga Cara", en: "Three Ways" },
  "work.forms.titleHighlight": {
    id: "Bekerja Bersama",
    en: "to Work Together",
  },
  "work.forms.website.title": { id: "Build a Website", en: "Build a Website" },
  "work.forms.website.desc": {
    id: "Untuk company profile, katalog, webstore, dan platform berbasis web.",
    en: "For company profiles, catalogs, webstores, and web-based platforms.",
  },
  "work.forms.product.title": { id: "Build a Product", en: "Build a Product" },
  "work.forms.product.desc": {
    id: "Untuk MVP, SaaS, aplikasi internal, aplikasi mobile, dan produk digital baru.",
    en: "For MVPs, SaaS, internal tools, mobile applications, and new digital products.",
  },
  "work.forms.improve.title": {
    id: "Improve an Existing Product",
    en: "Improve an Existing Product",
  },
  "work.forms.improve.desc": {
    id: "Untuk UI/UX, QA, perbaikan arsitektur, pengembangan fitur, dan optimasi sistem.",
    en: "For UI/UX, QA, architecture fixes, feature development, and system optimization.",
  },

  // WORK WITH US - ESTIMASI

  "work.estimate.label": { id: "Estimasi Kolaborasi", en: "Project Estimate" },
  "work.estimate.title": { id: "Gambaran", en: "Budget" },
  "work.estimate.titleHighlight": { id: "Anggaran", en: "Overview" },
  "work.estimate.subtitle": {
    id: "Supaya Anda punya gambaran sejak awal, berikut titik mulai untuk tiap bentuk pengerjaan.",
    en: "So you have a picture from the start, here are the starting points for each type of engagement.",
  },
  "work.estimate.startFrom": { id: "Mulai dari", en: "Starting from" },
  "work.estimate.scopeBased": {
    id: "Berdasarkan ruang lingkup proyek",
    en: "Based on project scope",
  },
  "work.estimate.disclaimer": {
    id: "Estimasi di atas merupakan harga awal. Biaya akhir ditentukan berdasarkan kompleksitas fitur, jumlah pengguna, integrasi, desain, target waktu, dan kebutuhan pemeliharaan.",
    en: "The estimates above are starting prices. Final cost is determined by feature complexity, number of users, integrations, design, timeline, and maintenance needs.",
  },
  "work.estimate.website.title": {
    id: "Website Development",
    en: "Website Development",
  },
  "work.estimate.website.desc": {
    id: "Cocok untuk company profile, portofolio, dan website bisnis sederhana.",
    en: "Suitable for company profiles, portfolios, and simple business websites.",
  },
  "work.estimate.cms.title": {
    id: "Website with Content Management",
    en: "Website with Content Management",
  },
  "work.estimate.cms.desc": {
    id: "Untuk website yang membutuhkan dashboard pengelolaan konten.",
    en: "For websites that need a content management dashboard.",
  },
  "work.estimate.webapp.title": {
    id: "Custom Web Application",
    en: "Custom Web Application",
  },
  "work.estimate.webapp.desc": {
    id: "Untuk sistem internal, dashboard operasional, manajemen data, dan workflow bisnis.",
    en: "For internal systems, operational dashboards, data management, and business workflows.",
  },
  "work.estimate.mvp.title": { id: "MVP Development", en: "MVP Development" },
  "work.estimate.mvp.desc": {
    id: "Untuk founder atau bisnis yang ingin membangun versi awal produk digital.",
    en: "For founders or businesses building the first version of a digital product.",
  },
  "work.estimate.product.title": {
    id: "Product Development",
    en: "Product Development",
  },
  "work.estimate.product.desc": {
    id: "Untuk sistem dengan banyak pengguna, integrasi, workflow kompleks, dan pengembangan bertahap.",
    en: "For systems with many users, integrations, complex workflows, and phased development.",
  },
  ...
  "home.faq.moreQuestions": {
    id: "Punya pertanyaan lain? Hubungi kami",
    en: "Have other questions? Contact us",
  },
  ...
  "faq.q2": {
    id: "Apakah Twenti Studio menyediakan layanan maintenance?",
    en: "Does Twenti Studio provide maintenance services?",
  },
  "faq.a2": {
  ...
  "faq.q3": {
    id: "Bagaimana proses kerja sama dengan Twenti Studio?",
    en: "How does the collaboration process work with Twenti Studio?",
  },
  "faq.a3": {
  ...
  "faq.q4": {
    id: "Bisakah mengintegrasikan dengan sistem yang sudah ada?",
  ...
  "faq.q5": {
    id: "Apakah source code menjadi milik klien?",
    en: "Does the client own the source code?",
  },
  "faq.a5": {
  ...
  "faq.q6": {
    id: "Bagaimana dengan skalabilitas aplikasi?",
    en: "What about application scalability?",
  },
  "faq.a6": {
  ...
  "home.cta.title": {
    id: "Siap Memulai Proyek Digital Anda?",
  ...
  "home.cta.freeConsultation": {
    id: "Konsultasi Gratis",
    en: "Free Consultation",
  },
  "home.cta.professionalTeam": {
    id: "Tim Profesional",
  ...
  "products.subtitle": {
    id: "Produk digital yang kami rancang, bangun, dan kembangkan sendiri untuk menyelesaikan masalah nyata. Di bawahnya, proyek yang kami kerjakan bersama klien.",
    en: "Digital products we design, build, and develop ourselves to solve real problems. Below them, the projects we built together with clients.",
  },
  "products.explore": { id: "Jelajahi", en: "Explore" },
  "products.exploreHighlight": { id: "Produk Kami", en: "Our Products" },
  "products.chooseRight": {
    id: "Pilih solusi yang tepat untuk kebutuhan Anda",
    en: "Choose the right solution for your needs",
  },
  "products.viewDetails": { id: "Lihat Detail", en: "View Details" },
  "products.learnMore": { id: "Pelajari Lebih Lanjut", en: "Learn More" },
  "products.customSolution": {
    id: "Butuh Solusi Custom?",
  ...
  "services.heroTitle": {
    id: "Layanan Pengembangan",
    en: "Development Services",
  },
  "services.heroHighlight": {
  ...
  "services.webDev.tagline": {
    id: "Website & Web Application",
  ...
  "services.design.tagline": {
    id: "Desain yang Fungsional",
  ...
  "services.consulting.tagline": {
    id: "Strategi Digital yang Tepat",
    en: "Right Digital Strategy",
  },
  ...
  "services.process.step1.desc": {
    id: "Kami memulai dengan mendengarkan kebutuhan Anda secara mendalam.",
    en: "We start by listening deeply to your needs.",
  },
  ...
  "services.process.step2.desc": {
    id: "Tim kami menyusun strategi dan membuat desain wireframe serta prototype.",
    en: "Our team develops strategy and creates wireframe designs and prototypes.",
  },
  ...
  "services.process.step3.desc": {
    id: "Proses pengembangan dengan metodologi agile dan testing berkelanjutan.",
    en: "Development process with agile methodology and continuous testing.",
  },
  ...
  "services.process.step4.desc": {
    id: "Peluncuran produk dengan persiapan matang dan dukungan post-launch.",
    en: "Product launch with thorough preparation and post-launch support.",
  },
  "services.process.step4.duration": { id: "Ongoing", en: "Ongoing" }, // Services CTA
  "services.cta.title": {
  ...
  "services.cta.button": { id: "Hubungi Kami Sekarang", en: "Contact Us Now" }, // CONTACT PAGE
  ...
  "contact.selectProjectType": {
    id: "Pilih Jenis Proyek",
    en: "Select Project Type",
  },
  "contact.message": { id: "Pesan", en: "Message" },
  "contact.messagePlaceholder": {
    id: "Ceritakan kebutuhan proyek Anda...",
    en: "Tell us about your project needs...",
  },
  ...
  "contact.locationLabel": { id: "Lokasi", en: "Location" }, // Services Options
  "contact.services.webDev": { id: "Web Development", en: "Web Development" },
  "contact.services.mobile": {
    id: "Mobile App Development",
    en: "Mobile App Development",
  },
  ...
  "contact.projectType.existing": {
    id: "Pengembangan Sistem Existing",
    en: "Existing System Development",
  },
  "contact.projectType.integration": {
    id: "Integrasi Sistem",
  ...
  "about.cta.title": {
    id: "Siap Membangun Sesuatu yang Bermakna?",
    en: "Ready to Build Something Meaningful?",
  },
  "about.cta.desc": {
  ...
  "footer.partOf": {
    id: "Part of Interdots Group ecosystem",
    en: "Part of Interdots Group ecosystem",
  },
  ...
  "legal.entity": {
    id: "PT Twenti Studio Nusantara",
    en: "PT Twenti Studio Nusantara",
  },
  "legal.operatedBy": {
    id: "Twenti Studio beroperasi di bawah badan hukum PT Twenti Studio Nusantara.",
    en: "Twenti Studio operates under the legal entity PT Twenti Studio Nusantara.",
  },
  "legal.operatedByShort": {
    id: "Di bawah PT Twenti Studio Nusantara",
    en: "Under PT Twenti Studio Nusantara",
  },

  // HALAMAN PORTOFOLIO (proyek klien)

  "portfolio.heroTitle": { id: "Portofolio", en: "Client" },
  "portfolio.heroHighlight": { id: "Klien", en: "Portfolio" },
  "portfolio.heroSubtitle": {
    id: "Produk dan sistem yang kami rancang serta bangun untuk bisnis dan organisasi. Klik salah satu untuk melihat detailnya.",
    en: "Products and systems we designed and built for businesses and organizations. Click any of them to see the details.",
  },
  "portfolio.emptyTitle": { id: "Segera Hadir", en: "Coming Soon" },
  "portfolio.emptyDesc": {
    id: "Proyek klien akan ditampilkan di sini.",
    en: "Client projects will be listed here.",
  },
  "portfolio.ctaTitle": {
    id: "Punya Masalah yang Perlu Diselesaikan?",
    en: "Have a Problem Worth Solving?",
  },
  "portfolio.ctaDesc": {
    id: "Ceritakan kebutuhan Anda. Kami bantu rancang dan bangun solusinya.",
    en: "Tell us what you need. We will help design and build the solution.",
  },
  "portfolio.viewProducts": {
    id: "Lihat Produk Twenti",
    en: "See Twenti Products",
  },

  // HALAMAN PAKET & HARGA

  "pricing.heroTitle": { id: "Paket", en: "Packages" },
  "pricing.heroHighlight": { id: "& Harga", en: "& Pricing" },
  "pricing.heroSubtitle": {
    id: "Supaya Anda punya gambaran anggaran sejak awal, berikut titik mulai untuk tiap bentuk pengerjaan.",
    en: "So you have a budget picture from the start, here are the starting points for each type of engagement.",
  },
  "pricing.popular": { id: "Paling Diminati", en: "Most Popular" },
  "pricing.chooseThis": { id: "Diskusikan Ini", en: "Discuss This" },
  "pricing.includes": { id: "Yang termasuk:", en: "What is included:" },
  "pricing.ctaTitle": {
    id: "Belum Yakin Masuk Paket yang Mana?",
    en: "Not Sure Which One Fits?",
  },
  "pricing.ctaDesc": {
    id: "Ceritakan kebutuhan Anda, kami bantu tentukan ruang lingkup dan estimasi yang sesuai. Konsultasi pertama gratis.",
    en: "Tell us your needs and we will help define the right scope and estimate. First consultation is free.",
  },

  // HALAMAN INSIGHT

  "insight.heroTitle": { id: "Insight", en: "Insight" },
  "insight.heroHighlight": { id: "Twenti", en: "from Twenti" },
  "insight.heroSubtitle": {
    id: "Catatan proses, riset produk, dan eksperimen yang kami kerjakan di balik layar.",
    en: "Process notes, product research, and experiments we work on behind the scenes.",
  },
  "insight.emptyTitle": {
    id: "Artikel Segera Hadir",
    en: "Articles Coming Soon",
  },
  "insight.emptyDesc": {
    id: "Kami sedang menyiapkan tulisan pertama. Sementara ini, Anda bisa melihat hasil kerja kami lewat produk dan portofolio.",
    en: "We are preparing our first piece. In the meantime, you can see our work through our products and portfolio.",
  },
};
