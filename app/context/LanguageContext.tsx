...
import { faqTranslations } from "../data/faq";
...
export const translations: Translations = {
  ...
  // FAQ dipindahkan ke app/data/faq.ts supaya server component bisa
  // ikut membacanya untuk structured data. Kunci "faq.q1"/"faq.a1"
  // tetap tersedia lewat spread di bawah.
  ...faqTranslations,
  ...
  "contact.whatsappLabel": { id: "WhatsApp", en: "WhatsApp" },
