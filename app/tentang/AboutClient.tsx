      ...
      <section className="py-20 bg-dark-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-dark-700 border border-white/10 rounded-xl p-8 mb-12">
            ...
            {/* Badan hukum resmi. Hanya disebutkan di halaman ini dan footer. */}
            <div className="p-5 bg-dark-600/50 border-l-2 border-orange-500 rounded-r-lg">
          ...
          <div className="bg-dark-700 border border-white/10 rounded-xl p-8 mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 text-orange-500">
                  {t("about.whatWeDo.consulting.title")}
                </h3>
                <p className="text-gray-300 leading-relaxed">
