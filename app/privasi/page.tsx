...
export const metadata: Metadata = {
    ...
    description: 'Privacy Policy for Twenti Studio - Learn how we collect, use, and protect your personal data.',
};
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-dark-800 border border-white/10 rounded-2xl p-8 md:p-12">
                    ...
                    <div className="prose prose-invert prose-orange max-w-none space-y-6">
                        ...
                        <p className="text-gray-300 leading-relaxed">For the purposes of this Privacy Policy:</p>
                        ...
                        <ul className="list-disc list-inside space-y-3 text-gray-300 ml-4">
                            ...
                            <li><strong className="text-white">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Twenti Studio Nusantara, Balikpapan, Kalimantan Timur.</li>
                            ...
                            <li><strong className="text-white">Country</strong> refers to: Indonesia</li>
                            ...
                            <li><strong className="text-white">Website</strong> refers to Twenti Studio, accessible from <a href="https://twenti.studio" className="text-orange-500 hover:text-orange-400 transition-colors" target="_blank" rel="noopener noreferrer">twenti.studio</a>.</li>
                        ...
                        <p className="text-gray-300 leading-relaxed">We use both Session and Persistent Cookies for the purposes set out below:</p>
                        ...
                        <ul className="list-disc list-inside space-y-3 text-gray-300 ml-4">
                            <li>
                                ...
                                <p className="ml-6">Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
                            </li>
                            <li>
                                ...
                                <p className="ml-6">Administered by: Us</p>
                                <p className="ml-6">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
                            </li>
                            <li>
                                <strong className="text-white">Functionality Cookies</strong>
                                <p className="ml-6 mt-1">Type: Persistent Cookies</p>
                                <p className="ml-6">Administered by: Us</p>
                                <p className="ml-6">Purpose: These Cookies allow Us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
                            </li>
                        </ul>
                        ...
                        <p className="text-gray-300 leading-relaxed">We may share Your Personal Data in the following situations:</p>
                        
                        <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
                            <li><strong className="text-white">With Service Providers:</strong> We may share Your Personal Data with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
                            ...
                            <li><strong className="text-white">With other users:</strong> If Our Service offers public areas, when You share Personal Data or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.</li>
                        ...
                        <p className="text-gray-300 leading-relaxed">We may retain Personal Data beyond the periods stated above for different reasons:</p>
                        ...
                        <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
                            <li>By email: <a href="mailto:twentistudio@gmail.com" className="text-orange-500 hover:text-orange-400 transition-colors">twentistudio@gmail.com</a></li>
                        </ul>
                    </div>
