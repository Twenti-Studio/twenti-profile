...
export const metadata: Metadata = {
  title: "Kebijakan Privasi | Twenti Studio",
  description:
    "Kebijakan privasi Twenti Studio: bagaimana kami mengumpulkan, menggunakan, dan melindungi data pribadi Anda.",
  ...
  return (
    <div className="min-h-screen bg-dark-900 pt-32 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-dark-800 border border-white/10 rounded-2xl p-8 md:p-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Privacy Policy
          </h1>
          <p className="text-gray-400 mb-8">Last updated: February 01, 2026</p>
          ...
          <div className="prose prose-invert prose-orange max-w-none space-y-6">
            ...
            <ul className="list-disc list-inside space-y-3 text-gray-300 ml-4">
              ...
              <li>
                ...
                either "the Company", "We", "Us" or "Our" in this Privacy
                Policy) refers to Twenti Studio Nusantara, Balikpapan,
                Kalimantan Timur.
              </li>
              <li>
              ...
              <li>
                ...
                identified or identifiable individual. We use "Personal Data"
                and "Personal Information" interchangeably unless a law uses a
                specific term.
              </li>
              <li>
              ...
              <li>
                <strong className="text-white">Website</strong> refers to Twenti
                Studio, accessible from{" "}
                <a
            ...
            <ul className="list-disc list-inside space-y-3 text-gray-300 ml-4">
              <li>
                ...
                <p className="ml-6 mt-1">Type: Session Cookies</p>
                <p className="ml-6">Administered by: Us</p>
                <p className="ml-6">
              ...
              <li>
                ...
                <p className="ml-6 mt-1">Type: Persistent Cookies</p>
                <p className="ml-6">Administered by: Us</p>
                <p className="ml-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              it is no longer needed for the relevant purpose. We apply
              different retention periods to different categories of Personal
